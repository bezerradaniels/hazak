    ...
    return (
        <section id="home" className="relative h-screen min-h-150 flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(0,0,0,0.9), rgba(0,0,0,0.5), transparent)' }} />
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, #111111, transparent, transparent)' }} />
            </div>

            <div className="container mx-auto px-[1em] md:px-[2em] relative z-10 pt-20">
                <motion.div
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <motion.a
                            id="hero-fazer-matricula-wpp-btn"
