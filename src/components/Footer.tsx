        ...
        <footer id="contact" className="bg-primary text-black pt-20 pb-10">
            <div className="container mx-auto px-[1em] md:px-[2em]">
                ...
                <div className="border-t border-black/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="text-sm font-medium opacity-70">
                        Desenvolvido por <a id="footer-dev-link-btn" href="https://dani.dev.br" target="_blank" rel="noopener noreferrer">Daniel Bezerra</a>
                    </div>

                    <div className="flex gap-4">
                        <a id="footer-instagram-btn" href="#" className="p-2 bg-black/5 rounded-full hover:bg-black hover:text-primary transition-colors">
                            <Instagram size={20} />
                        </a>
                        <a id="footer-facebook-btn" href="#" className="p-2 bg-black/5 rounded-full hover:bg-black hover:text-primary transition-colors">
                            <Facebook size={20} />
                        </a>
                    </div>
                </div>
